            ...
            <div className="relative z-10 p-8">
              ...
              >
                ...
                <p className="text-white/60 text-center">
                  Sign in to access your lightning-fast storage
                </p>
              </motion.div>
              ...
              >
                ...
                <div className="space-y-6">
                  <div>
                    <h3 className="text-lg font-semibold text-white mb-4">Email Sign In</h3>
                    <form onSubmit={handleSubmit} className="space-y-4">
                      ...
                      <div className="flex items-center justify-between">
                        <label className="flex items-center">
                          <input
                            type="checkbox"
                            className="w-4 h-4 rounded border-white/10 bg-white/[0.02] text-blue-500 focus:ring-blue-500/50"
                          />
                ...
                <div className="space-y-6">
                  <div>
                    <h3 className="text-lg font-semibold text-white mb-4">Quick Sign In</h3>
                  ...
                  <div className="relative">
                    ...
                    <div className="relative flex justify-center text-sm">
                      <span className="px-4 bg-transparent text-white/40">New to BoltStorage?</span>
                    </div>
                  </div>
